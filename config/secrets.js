...
if(process.env.NODE_ENV === 'test-travis') {
  ...
  module.exports.postgrescomm = 'postgres://postgres:black@123@127.0.0.1/ondemand';
  module.exports.postgreschat = 'postgres://postgres:black@123@127.0.0.1/chat';
} else {
  module.exports.postgres = process.env.DATABASE_URL || 'postgres://postgres:123@127.0.0.1/prod';
}

// if(process.env.NODE_ENV === 'mysql-dev') {
//   module.exports.mysqlcomm = 'mysql://test:black@123@127.0.0.1/ondemand';
//   module.exports.mysqlchat = 'mysql://test:black@123@127.0.0.1/chat';
// }
// else {
